    ...
    <div className='p-3'>
      <div className='row p-3 m-4'>
        <div className='col-lg-3 col-md-6 p-3'>
          <Form.Select className='p-3' value={date} onChange={handleOptionChange}>
        ...
        <div className="col-lg-3 col-md-6 p-3">
          <Dropdown className='w-100'>
            <Dropdown.Toggle className="border border-secondary border-opacity-25 bg-white w-100 p-3" variant="" id="dropdown-basic">
              Choose Years
            </Dropdown.Toggle>
        ...
        <div className='col-lg-2 col-md-6 col-sm-6 p-3'>
          <Button className='p-3 w-100 btn-danger' onClick={goingback}>GOBACK</Button>
        </div>
        <div className='col-lg-2 col-md-6 col-sm-6 p-3 ms-auto'>
          <Button onClick={handleSearchTime} className='p-3 w-100 bg-success border-success'>Search</Button>
        </div>
